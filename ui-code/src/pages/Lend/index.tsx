...
import { postLendAd } from "../../services";
...
const Lend = () => {
    ...
    const onSubmit = async (e: any) => {
        e.preventDefault();
        await postLendAd(formData);
        dispatch(updateUserState(userStateEnum.LEND));
        navigate(`/lending`);
    };
        ...
        <Box component="div">
            <Card
                sx={{
                    ...
                    padding: "3rem 2.2rem",
                    background:
                        "linear-gradient(180deg, #FFFFFF 0%, #FDF4E3 100%)",
                }}
            >
                <Typography
                    variant="h1"
                ...
                <form onSubmit={onSubmit}>
                    ...
                    >
                        How much <strong>amount</strong> do you want to lend?
                    </Typography>
                    <Box sx={{ mb: "3rem" }}>
                        <FormControl
                            variant="filled"
                    ...
                    <Box sx={{ mb: "3rem" }}>
                        ...
                        >
                            How <strong>long</strong> can you offer loans?
                        </Typography>
                        <FormControl
                            variant="filled"
                            sx={{ width: "44%", mr: "2rem" }}
                    ...
                    <Box sx={{ mb: "3rem" }}>
                        ...
                        >
                            At what <strong>interest</strong> rate can you lend?
                        </Typography>
                        <FormControl
                            variant="filled"
                            sx={{ width: "44%", mr: "2rem" }}
